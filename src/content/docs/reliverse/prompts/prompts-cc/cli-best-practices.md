...
description: "A collection of curated best practices on how to build successful, empathic and user-friendly Node.js Command Line Interface (CLI) applications."
---
...
This page is only the adaptation of the original document. This document is a LLM-friendly version of [the original document](https://github.com/lirantal/nodejs-cli-apps-best-practices/blob/main/README.md). It has been adapted to provide a more LLM-friendly structure and format, making the content more accessible and easy to use for educational and technical purposes. Please refer to the [License and Credits](#license-and-credits) section for more details.
...
- ✅ Read the original document in a different language: [🇨🇳](./README_zh-Hans.md), [🇪🇸](./README_es.md), or [help translate](https://crowdin.com/project/nodejs-cli-apps-best-practices) to other languages. [Suggest new languages](https://crowdin.com/project/nodejs-cli-apps-best-practices/discussions).
- 🙏 Contributions are welcome (to the original document)
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| oclif  | A framework for building a command line interface.  | [NPM](https://www.npmjs.com/package/oclif) | [GitHub](https://github.com/oclif/oclif) | ![](https://img.shields.io/github/stars/oclif/oclif)![](https://img.shields.io/npm/dt/oclif.svg)
| inquirer  | A collection of common interactive command line user interfaces.  | [NPM](https://www.npmjs.com/package/inquirer) | [GitHub](https://github.com/SBoudrias/Inquirer.js) |![](https://img.shields.io/github/stars/sboudrias/inquirer.js)![](https://img.shields.io/npm/dt/inquirer.svg)
| ink | Ink provides the same component-based UI building experience that React offers in the browser, but for command-line apps. | [NPM](https://www.npmjs.com/package/ink) | [GitHub](https://github.com/vadimdemedes/ink) | ![](https://img.shields.io/github/stars/vadimdemedes/ink)![](https://img.shields.io/npm/dt/ink.svg)
| pastel | Next.js-like framework for CLIs made with Ink. | [NPM](https://www.npmjs.com/package/pastel) | [GitHub](https://github.com/vadimdemedes/pastel) | ![](https://img.shields.io/github/stars/vadimdemedes/pastel)![](https://img.shields.io/npm/dt/pastel.svg)
| ink UI | Collection of customizable UI components for CLIs made with Ink. | [NPM](https://www.npmjs.com/package/@inkjs/ui) | [GitHub](https://github.com/vadimdemedes/ink-ui) | ![](https://img.shields.io/github/stars/vadimdemedes/ink-ui)![](https://img.shields.io/npm/dt/@inkjs/ui.svg)
|blessed |A curses-like library with a high level terminal interface API for node.js.| [NPM](https://www.npmjs.com/package/blessed) | [GitHub](https://github.com/chjj/blessed) | ![](https://img.shields.io/github/stars/chjj/blessed)![](https://img.shields.io/npm/dt/blessed.svg)
| prompts | Lightweight, beautiful and user-friendly interactive prompts | [NPM](https://npmjs.org/package/prompts) | [GitHub](https://github.com/terkelg/prompts) | ![](https://img.shields.io/github/stars/terkelg/prompts)![](https://img.shields.io/npm/dt/prompts.svg)
| vue-termui  | A Vue.js based terminal UI framework that allows you to build modern terminal applications with ease. | [NPM](https://www.npmjs.org/package/vue-termui)      | [GitHub](https://github.com/vue-terminal/vue-termui)       | ![](https://img.shields.io/github/stars/vue-terminal/vue-termui)![](https://img.shields.io/npm/dt/vue-termui.svg)        |
| clack       | Effortlessly build beautiful command-line apps   | [NPM](https://www.npmjs.com/package/@clack/prompts) | [GitHub](https://github.com/natemoo-re/clack/tree/main/packages/prompts) | ![](https://img.shields.io/github/stars/natemoo-re/clack)![](https://img.shields.io/npm/dt/@clack/prompts.svg)
...
<p align="center">
<a href="http://creativecommons.org/licenses/by-sa/4.0/"><img src="https://badgen.net/badge/License/CC%20BY-SA%204.0/green"/></a>
...
The original project follows the [all-contributors](https://github.com/all-contributors/all-contributors) specification. Contributions of any kind are welcome (to the original project)!

Thanks to the wonderful contributors ([emoji key](https://allcontributors.org/docs/en/emoji-key)):
...
This document is the adaptation of **[Node.js CLI Apps Best Practices](https://github.com/lirantal/nodejs-cli-apps-best-practices#readme)** by **[Liran Tal](https://github.com/lirantal)** has been designed to provide a more LLM-friendly format while retaining the essential technical and educational aspects of the original work.

**Purpose**:  
The primary goal of this adaptation is to make the original document more accessible for integration with machine-learning tools and easier to understand for broader audiences, including developers seeking concise, structured guidance.

**Attribution**:  

- Original author: **[Liran Tal](https://github.com/lirantal)**  
- Original work: **[Node.js CLI Apps Best Practices](https://github.com/lirantal/nodejs-cli-apps-best-practices)**  
- Licensed under the [CC BY-SA 4.0](http://creativecommons.org/licenses/by-sa/4.0/) license.
